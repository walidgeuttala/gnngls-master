...
#SBATCH --time=2-00:00:00        # Maximum walltime (30 minutes)
...
python train.py ../cleaned_data_n5900 ../model_result_n5900 --use_gpu
python test_save2.py ../cleaned_data_n5900/test.txt ../model_result_n5900/checkpoint_best_val.pt ../run_result_n5900 regret_pred ../test_tsp_n5900 --use_gpu
